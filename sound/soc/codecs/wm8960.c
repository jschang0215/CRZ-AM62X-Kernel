...
SOC_DOUBLE_R("Speaker Playback ZC Switch", WM8960_LOUT2, WM8960_ROUT2,
	7, 1, 0),
//crazyboys 20151222 noise fix
//SOC_SINGLE("Speaker DC Volume", WM8960_CLASSD3, 3, 5, 0),
//SOC_SINGLE("Speaker AC Volume", WM8960_CLASSD3, 0, 5, 0),
SOC_SINGLE("Speaker DC Volume", WM8960_CLASSD3, 3, 0, 0),
SOC_SINGLE("Speaker AC Volume", WM8960_CLASSD3, 0, 0, 0),
...
//	if (!(iface1 & (1 << 6)) && !wm8960->sysclk) {
	if (!(iface1 & (1 << 6))) {
	 MANGO_DBG("Codec is slave mode, no need to configure clock\n");
			    ...
			    struct snd_soc_dai *dai)
{
	...
	MANGO_DBG("snd_soc_component_get_bias_level(component)=%d\n",snd_soc_component_get_bias_level(component));
	MANGO_DBG("!wm8960->is_stream_in_use[!tx]=%d\n",!wm8960->is_stream_in_use[!tx]);
				      ...
				      enum snd_soc_bias_level level)
{
	...
	case SND_SOC_BIAS_ON:
		MANGO_DBG("SND_SOC_BIAS_ON\n");
		reg = snd_soc_component_read(component, 0x5);      // 18
		MANGO_DBG("WM8960_DACCTL1(0x05)=0x%x\n",reg);
        	snd_soc_component_write(component, 0x5, 0x0);
		reg = snd_soc_component_read(component, 0x7);      // 18
		MANGO_DBG("WM8960_IFACE1(0x07)=0x%x\n",reg);
        	snd_soc_component_write(component, 0x7, 0x2);
		reg = snd_soc_component_read(component, 0x19);      // 18
		MANGO_DBG("WM8960_POWER1(0x19)=0x%x\n",reg);
        	snd_soc_component_write(component, 0x19, 0xee);
		break;

	case SND_SOC_BIAS_PREPARE:
		MANGO_DBG("SND_SOC_BIAS_PREPARE\n");
		switch (snd_soc_component_get_bias_level(component)) {
		case SND_SOC_BIAS_STANDBY:
		MANGO_DBG("SND_SOC_BIAS_PREPARE->SND_SOC_BIAS_STANDBY\n");
		...
		case SND_SOC_BIAS_ON:
			...
			MANGO_DBG("SND_SOC_BIAS_PREPARE->SND_SOC_BIAS_ON\n");
			/*
	...
	case SND_SOC_BIAS_STANDBY:
		MANGO_DBG("SND_SOC_BIAS_STANDBY\n");
	//crazyboys 20180727 
		...
		unsigned int freq_in, unsigned int freq_out)
{
	...
	if (pll_div.k) {
		...
		snd_soc_component_write(component, WM8960_CLOCK2, 0x1C4);//BCLK => sysclk/4=64fs //crazyboys 20180727 
	}
	// CRZ icanjji  Prescale fix to 0
        reg &= ~0x010;
...
MANGO_DBG("\n");
	...
	default:
        ...
        // crazyboys  CRZ icanjji   System clock divide by 2 fix from sar1000-es
        reg = snd_soc_component_read(component, WM8960_CLOCK1);
        reg |= 0x004;
        reg &= ~0x002;
        snd_soc_component_write(component, WM8960_CLOCK1, reg | div);
...
MANGO_DBG_DEFAULT;
	...
	wm8960->set_bias_level(component, SND_SOC_BIAS_STANDBY);
        ...
        reg = snd_soc_component_read(component, WM8960_LINVOL);
        snd_soc_component_write(component, WM8960_LINVOL, reg | 0x13F);
        reg = snd_soc_component_read(component, WM8960_RINVOL);
        snd_soc_component_write(component, WM8960_RINVOL, reg | 0x13F);
        reg = snd_soc_component_read(component, WM8960_LADC);
        snd_soc_component_write(component, WM8960_LADC, reg | 0x100);
        reg = snd_soc_component_read(component, WM8960_RADC);
        snd_soc_component_write(component, WM8960_RADC, reg | 0x100);
        reg = snd_soc_component_read(component, WM8960_LDAC);
        snd_soc_component_write(component, WM8960_LDAC, reg | 0x100);
        reg = snd_soc_component_read(component, WM8960_RDAC);
        snd_soc_component_write(component, WM8960_RDAC, reg | 0x100);
        reg = snd_soc_component_read(component, WM8960_LOUT1);
        snd_soc_component_write(component, WM8960_LOUT1, reg | 0x100);
        reg = snd_soc_component_read(component, WM8960_ROUT1);
        snd_soc_component_write(component, WM8960_ROUT1, reg | 0x100);
        reg = snd_soc_component_read(component, WM8960_LOUT2);
        snd_soc_component_write(component, WM8960_LOUT2, reg | 0x100);
        reg = snd_soc_component_read(component, WM8960_ROUT2);
        snd_soc_component_write(component, WM8960_ROUT2, reg | 0x100);

        reg = snd_soc_component_read(component, WM8960_POWER2);
        snd_soc_component_write(component, WM8960_POWER2, reg | 0x018); // 1A h
        reg = snd_soc_component_read(component, WM8960_CLASSD1);
        snd_soc_component_write(component, WM8960_CLASSD1, reg | 0x0C0); // 31 h
        reg = snd_soc_component_read(component, WM8960_LOUT2);
        //printk("CRZ WM8960_LOUT2=0x%x\n",reg);
        //crazyboys 20151222 nexchal noise fix
        snd_soc_component_write(component, WM8960_LOUT2, reg | 0x079);
        //snd_soc_component_write(component, WM8960_LOUT2, reg | 0x07F);
        printk("CRZ WM8960_LOUT2=0x%x\n",snd_soc_component_read(component, WM8960_LOUT2));
        reg = snd_soc_component_read(component, WM8960_ROUT2);
        //crazyboys 20151222 nexchal noise fix
        snd_soc_component_write(component, WM8960_ROUT2, reg | 0x079);
        //snd_soc_component_write(component, WM8960_ROUT2, reg | 0x07F);
        printk("CRZ WM8960_ROUT2=0x%x\n",snd_soc_component_read(component, WM8960_ROUT2));
        //crazyboys 20151222 nexchal noise fix
        reg = snd_soc_component_read(component, WM8960_CLASSD3);
        snd_soc_component_write(component, WM8960_CLASSD3, reg | 0x000);
        printk("CRZ WM8960_CLASSD3=0x%x\n",snd_soc_component_read(component, WM8960_CLASSD3));
...
*/
        ...
        reg = snd_soc_component_read(component, 0x00);
        snd_soc_component_write(component, 0x00, reg & ~(0x080)); // 00h
        reg = snd_soc_component_read(component, 0x2B);
        snd_soc_component_write(component, 0x2B, reg & ~(0x07e)); // 2bh
        reg = snd_soc_component_read(component, 0x22);
        snd_soc_component_write(component, 0x22, reg & ~(0x080)); // 2bh


        reg = snd_soc_component_read(component, WM8960_POWER1);
        snd_soc_component_write(component, WM8960_POWER1, reg | 0x02a); // 19h
        reg = snd_soc_component_read(component, WM8960_LINPATH);
        snd_soc_component_write(component, WM8960_LINPATH, reg | 0x148); //20h
        reg = snd_soc_component_read(component, WM8960_POWER3);
        snd_soc_component_write(component, WM8960_POWER3, reg | 0x020); // 2Fh
        ...
        reg = snd_soc_component_read(component, WM8960_ADDCTL1);      // 17
        snd_soc_component_write(component, WM8960_ADDCTL1, reg | 0x001);
        reg = snd_soc_component_read(component, WM8960_ADDCTL2);      // 18
        snd_soc_component_write(component, WM8960_ADDCTL2, reg | 0x060);
        reg = snd_soc_component_read(component, WM8960_ADDCTL3);      // 1b
        snd_soc_component_write(component, WM8960_ADDCTL3, reg | 0x008);
        reg = snd_soc_component_read(component, WM8960_IFACE2);       // 09
        snd_soc_component_write(component, WM8960_IFACE2, reg | 0x040);
        reg = snd_soc_component_read(component, WM8960_LOUT1);        // 02
        snd_soc_component_write(component, WM8960_LOUT1, reg | 0x07f);
        reg = snd_soc_component_read(component, WM8960_ROUT1);        // 03
        snd_soc_component_write(component, WM8960_ROUT1, reg | 0x07f);

        // MIC L,R-INPUT1 Enable : by pjlee
        // WMIDSEL=1, VREF=1, AINL=1, AINR=1, ADCL=1, MICB=0, DIGENB=0
        snd_soc_component_write(component, WM8960_POWER1, 0x00FC);
        // LIMC=1, RMIC=1, LOMIX=0, ROMIX=0
        snd_soc_component_write(component, WM8960_POWER3, 0x0030);
        // LMN1=1, LMP3=0, LMP2=0, LMICBOOST=0, LMIC2B=1
        snd_soc_component_write(component, WM8960_LINPATH, 0x0138);
        // RMN1=1, RMP3=0, RMP2=0, RMICBOOST=0, RMIC2B=1
        snd_soc_component_write(component, WM8960_RINPATH, 0x0138);
        // IPVU=1, LINMUTE=0, LIZC=0, LINVOL=01_0111
        snd_soc_component_write(component, WM8960_LINVOL, 0x0117);
        // IPVU=1, RINMUTE=0, RIZC=0, RINVOL=01_0111
        snd_soc_component_write(component, WM8960_RINVOL, 0x0117);
        // ADCVU=1, LADCVOL=1100_0011
        snd_soc_component_write(component, WM8960_LADC, 0x01C3);
        // ADCVU=1, RADCVOL=1100_0011
        snd_soc_component_write(component, WM8960_RADC, 0x01C3);

#endif
#if 0//CRZ_icanjji crazyboys 20160920
	snd_soc_component_write(component, WM8960_APOP1, 0x94);
	snd_soc_component_write(component, WM8960_APOP2, 0x40);
	msleep(400);   /* HP output discharge */
	snd_soc_component_write(component, WM8960_POWER2, 0x0);
	snd_soc_component_write(component, WM8960_APOP2, 0);
	snd_soc_component_write(component, WM8960_POWER1, 0x80);
	msleep(400);   /* VMID initial charge */
	snd_soc_component_write(component, WM8960_POWER1, 0x142);
	snd_soc_component_write(component, WM8960_APOP1, 0);
	//---------------------------------------------------------------//
	snd_soc_component_write(component, WM8960_LOUT2, 0xFF);
	snd_soc_component_write(component, WM8960_ROUT2, 0xFF);
	snd_soc_component_write(component, WM8960_CLASSD1, 0x40);
	snd_soc_component_write(component, WM8960_CLASSD3, (0x05<<3)|0x04);
	// snd_soc_set_bias_level(component, SND_SOC_BIAS_STANDBY);
	/*  set the update bits */
	reg = snd_soc_component_read(component, WM8960_LOUT1);
	snd_soc_component_write(component, WM8960_LOUT1, reg | 0x0100);
	reg = snd_soc_component_read(component, WM8960_ROUT1);
	snd_soc_component_write(component, WM8960_ROUT1, reg | 0x0100);
	reg = snd_soc_component_read(component, WM8960_LOUT2);
	snd_soc_component_write(component, WM8960_LOUT2, reg | 0x0100);
	reg = snd_soc_component_read(component, WM8960_ROUT2);
	snd_soc_component_write(component, WM8960_ROUT2, reg | 0x0100);
	reg = snd_soc_component_read(component, WM8960_LOUTMIX);
	snd_soc_component_write(component, WM8960_LOUTMIX, reg | 0x0100);
	reg = snd_soc_component_read(component, WM8960_ROUTMIX);
	snd_soc_component_write(component, WM8960_ROUTMIX, reg | 0x0100);
	...
	/* Latch the update bits */
	// reg = snd_soc_component_read(component, WM8960_LINVOL);
	// snd_soc_component_write(component, WM8960_LINVOL, reg | 0x100);
	// reg = snd_soc_component_read(component, WM8960_RINVOL);
	// snd_soc_component_write(component, WM8960_RINVOL, reg | 0x100);
	// reg = snd_soc_component_read(component, WM8960_LADC);
	// snd_soc_component_write(component, WM8960_LADC, reg | 0x100);
	// reg = snd_soc_component_read(component, WM8960_RADC);
	// snd_soc_component_write(component, WM8960_RADC, reg | 0x100);
	...
	//CRZ 
	reg = snd_soc_component_read(component, WM8960_ADDCTL1); // 17
	snd_soc_component_write(component, WM8960_ADDCTL1, reg | 0x004); //  01: left data = left ADC; right data= left ADC
	reg = snd_soc_component_read(component, WM8960_ADDCTL2);      // 18
	//snd_soc_component_write(component, WM8960_ADDCTL2, reg | 0x040);//CRZ Speaker 
	snd_soc_component_write(component, WM8960_ADDCTL2, reg | 0x060);//CRZ HP switch 
	reg = snd_soc_component_read(component, WM8960_ADDCTL3);      // 1b
	snd_soc_component_write(component, WM8960_ADDCTL3, reg | 0x008);
	reg = snd_soc_component_read(component, WM8960_IFACE2);       // 09
	snd_soc_component_write(component, WM8960_IFACE2, reg | 0x040);
	...
	reg = snd_soc_component_read(component, WM8960_ROUT1);        // 03
	snd_soc_component_write(component, WM8960_ROUT1, reg | 0x07f);
	// MIC L,R-INPUT1 Enable : 
	// WMIDSEL=1, VREF=1, AINL=1, AINR=1, ADCL=1, MICB=0, DIGENB=0
	snd_soc_component_write(component, WM8960_POWER1, 0x00FC);
	// LIMC=1, RMIC=1, LOMIX=0, ROMIX=0
	snd_soc_component_write(component, WM8960_POWER3, 0x0030);
	// LMN1=1, LMP3=0, LMP2=0, LMICBOOST=0, LMIC2B=1
	snd_soc_component_write(component, WM8960_LINPATH, 0x0128);
	// RMN1=1, RMP3=0, RMP2=0, RMICBOOST=0, RMIC2B=1
	snd_soc_component_write(component, WM8960_RINPATH, 0x0128);
	// IPVU=1, LINMUTE=0, LIZC=0, LINVOL=01_0111
	snd_soc_component_write(component, WM8960_LINVOL, 0x0117);
	// IPVU=1, RINMUTE=0, RIZC=0, RINVOL=01_0111
	snd_soc_component_write(component, WM8960_RINVOL, 0x0117);
