...
#define MANGO_DBG(fmt, ...) \
	printk(CRZ_ANSI_TEXT_GREEN "[CRZ]" CRZ_ANSI_TEXT_RESET " %s (%d) %s: " fmt, __FILE__, __LINE__, __func__, ##__VA_ARGS__)
#define MANGO_ERROR(fmt, ...) \
	printk(CRZ_ANSI_TEXT_RED "[CRZ]" CRZ_ANSI_TEXT_RESET " %s (%d) %s: " fmt, __FILE__, __LINE__, __func__, ##__VA_ARGS__)
#define MANGO_DBG_DEFAULT MANGO_DBG("\n");
#define MANGO_DBG_YELLOW(fmt, ...) \
	printk(CRZ_ANSI_TEXT_YELLOW "[CRZ]" CRZ_ANSI_TEXT_RESET " %s (%d) %s: " fmt, __FILE__, __LINE__, __func__, ##__VA_ARGS__)
#define MANGO_DBG_BLUE(fmt, ...) \
	printk(CRZ_ANSI_TEXT_BLUE "[CRZ]" CRZ_ANSI_TEXT_RESET " %s (%d) %s: " fmt, __FILE__, __LINE__, __func__, ##__VA_ARGS__)
#define MANGO_DBG_RED(fmt, ...) \
	printk(CRZ_ANSI_TEXT_RED "[CRZ]" CRZ_ANSI_TEXT_RESET " (%d) %s: " fmt, __LINE__, __func__, ##__VA_ARGS__)
